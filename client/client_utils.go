...
func (c The_0_Stor) doReqWithBody(method, urlStr string, data interface{}, headers, queryParams map[string]interface{}) (*http.Response, error) {
...
func (c The_0_Stor) doReqNoBody(method, urlStr string, headers, queryParams map[string]interface{}) (*http.Response, error) {
	return c.doReq(method, urlStr, nil, headers, queryParams)
}

func (c The_0_Stor) doReq(method, urlStr string, body io.Reader, headers, queryParams map[string]interface{}) (*http.Response, error) {
	// create the request
